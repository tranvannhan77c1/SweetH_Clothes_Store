...
INSERT INTO products (thumbnail_image, [name], price, quantity, brand, made_in, color, material, description, category_id) VALUES
    ...
    ('https://img.ltwebstatic.com/images3_pi/2024/05/15/99/17157381111b9c3eae412a4b86cec29d2c32dade0b_thumbnail_900x.webp', 'Pleated Short',11.61 , 50, 'Canifa', 'Made In VietNam', 'Khaki', 'Cotton', 'Priv� Women Khaki Pleated Short Wide Leg Jumpsuit,Belt Not Included,Suitable For Daily, Commuting, Holiday, Dating,Wide-Legged One-Piece Shorts', 6),
    ...
    ('https://img.ltwebstatic.com/images3_pi/2024/01/22/26/1705889372576a0a5eab5dfc0a9cb42ec85237c04a_thumbnail_900x.webp', 'Drop Shoulder Drawstring1',13.57 , 50, 'Gucci', 'Made In USA', 'Khaki', 'Cotton', 'EZwear Zip Up Drop Shoulder Drawstring Hooded Thermal Lined Zip Up Jacket', 8);
    ...
    ('https://img.ltwebstatic.com/images3_pi/2022/08/26/16614798656bd0c20d513c2b761aa3c60fe8a70689_thumbnail_900x.webp', 'Contrast Trim Polo',9.51 , 50, 'Canifa', 'Made In VietNam', 'Navy Blue', 'Cotton', 'Manfinity Homme Men Contrast Trim Polo Shirt', 10),
    ('https://img.ltwebstatic.com/images3_pi/2023/07/08/168882121683217386df2341e67f52ece7325dc922_thumbnail_900x.webp', 'Loose Fit',10.24 , 50, 'Yody', 'Made In China', 'Dark Grey', 'Cotton', 'Manfinity Homme Loose Fit Mens Drawstring Cargo Shorts', 10),
    ('https://img.ltwebstatic.com/images3_pi/2022/12/06/1670307438183d1f7a17ff20334e77ee3d4d16ff86_thumbnail_900x.webp', 'Flap Pocket Shirt',18.20 , 50, 'OWen', 'Made In Indonesia', 'Navy Khaki', 'Cotton', 'Manfinity Homme Men 1pc Flap Pocket Shirt & 1pc Drawstring Waist Shorts', 10),
    ('https://img.ltwebstatic.com/images3_pi/2022/12/06/1670307438183d1f7a17ff20334e77ee3d4d16ff86_thumbnail_900x.webp', 'Tropical Print Shirt',8.60 , 50, 'Gumac', 'Made In VietNam', 'Black and White', 'Cotton', 'Manfinity RSRT Men Tropical Print Shirt & Drawstring Waist Shorts Without Tee', 10),
    ('https://img.ltwebstatic.com/images3_pi/2022/12/06/1670307438183d1f7a17ff20334e77ee3d4d16ff86_thumbnail_900x.webp', 'Gingham Trim',10.42 , 50, 'Tingoan', 'Made In VietNam', 'Navy Blue', 'Cotton', 'Manfinity Homme Men Gingham Trim Polo Shirt', 10),
    ('https://img.ltwebstatic.com/images3_pi/2023/08/25/c6/16929262605803e932d686e8a7e696ef988020c3a7_thumbnail_900x.webp', 'Waist Cargo Shorts',8.06 , 50, 'Gumac', 'Made In VietNam', 'Grey', 'Cotton', 'Manfinity Homme Men Flap Pocket Side Drawstring Waist Cargo Shorts', 10),
    ('https://img.ltwebstatic.com/images3_pi/2023/08/25/c6/16929262605803e932d686e8a7e696ef988020c3a7_thumbnail_900x.webp', 'Cartoon Graphic Tee',13.57 , 50, 'Gucci', 'Made In USA', 'Light Grey', 'Cotton', 'Manfinity Homme Men Cartoon Graphic Tee', 10);

	INSERT INTO products (thumbnail_image, [name], price, quantity, brand, made_in, color, material, description, category_id) VALUES
    ('https://img.ltwebstatic.com/images3_pi/2024/04/11/19/171280729763899c853183cbf3f525bdca06aab656_thumbnail_900x.webp', 'Hawaiian Shirt Plant',12.99 , 50, 'Gumac', 'Made In VietNam', 'Multicolor', 'Cotton', 'Manfinity RSRT Men Plus Size Vacation Casual Hawaiian Shirt Plant & Ape Print Short Sleeve Shirt', 11),
    ('https://img.ltwebstatic.com/images3_pi/2024/06/04/8c/1717471422a672d3c2620ae8a90ebd646179537b4f_thumbnail_900x.webp', 'Casual Polo Shirt',11.49 , 50, 'Canifa', 'Made In VietNam', 'Black', 'Cotton', 'Mens Summer Solid Short Sleeve Casual Polo Shirt For Commute', 11),
    ('https://img.ltwebstatic.com/images3_pi/2024/05/29/bb/17169868840bdefa916ee13a206569c6184e1378f1_thumbnail_900x.webp', 'Breasted Printed Holiday',19.99 , 50, 'Yody', 'Made In China', 'Multicolor', 'Cotton', 'Manfinity AFTRDRK Mens Single-Breasted Printed Holiday Short Sleeve Shirt And Shorts Set', 11),
    ('https://img.ltwebstatic.com/images3_pi/2023/05/05/16832499810f91ff5db9304c00d6e0b24c08498584_thumbnail_900x.webp', 'Shirt & Shorts Set',19.99 , 50, 'OWen', 'Made In Indonesia', 'White', 'Cotton', 'Manfinity Homme Men Solid Button Up Shirt & Shorts Set', 11),
    ('https://img.ltwebstatic.com/images3_pi/2024/05/22/d1/17163566521afa11fd72a4c6ea2fb0616e1505f7bf_thumbnail_900x.webp', 'Sleeve Polo Shirt',16.99 , 50, 'Gumac', 'Made In VietNam', 'Baby Blue', 'Cotton', 'Mens Solid Color Short Sleeve Polo Shirt And Drawstring Shorts Summer Casual Outfit', 11),
    ('https://img.ltwebstatic.com/images3_pi/2024/05/20/d0/1716191859d32e533812c187b9bf8c6746c0ebd50f_thumbnail_900x.webp', 'Casual Denim Shorts',24.49 , 50, 'Tingoan', 'Made In VietNam', 'Dark Grey', 'Cotton', 'Manfinity EMRG Mens Drawstring Waist Workwear Style Pocketed Casual Denim Shorts', 11),
    ('https://img.ltwebstatic.com/images3_pi/2023/11/09/c4/1699459355f74b39b57f6cb62a8c35ae4ae68c6c52_thumbnail_900x.webp', 'Solid Color Hoodie',12.74 , 50, 'Gumac', 'Made In VietNam', 'Dark Grey', 'Cotton', 'Men Fashionable Solid Color Hoodie Flap Pocket Side Drawstring Waist Cargo Shorts', 11),
    ('https://img.ltwebstatic.com/images3_spmp/2024/06/06/e0/17176349222bf230a74933312cdc400159b6c5b421_thumbnail_900x.webp', 'Polyester Sweatshirt',24.99 , 50, 'Gucci', 'Made In USA', 'Dark Blue', 'Cotton', 'Manfinity Homme Men Polyester Sweatshirt (N/A)', 11);

	INSERT INTO products (thumbnail_image, [name], price, quantity, brand, made_in, color, material, description, category_id) VALUES
    ('https://img.ltwebstatic.com/images3_spmp/2024/03/28/ae/171163106650f319faba68cc3fac2cd2c5fabf6ed6_thumbnail_900x.webp', 'Classy Lapel Collar',42.99 , 50, 'Gumac', 'Made In VietNam', 'Navy Blue', 'Cotton', 'Men Four Seasons Classy Lapel Collar Long Sleeve Suit Jacket And Trousers Business Suit', 12),
    ('https://img.ltwebstatic.com/images3_pi/2024/03/25/5c/1711349736f0b92ac89f585b032f95a5c050bf2555_thumbnail_900x.webp', 'Breasted Suit Jacket',19.20 , 50, 'Canifa', 'Made In VietNam', 'Black', 'Cotton', 'Manfinity Mode 2pcs/Set Mens Plus Size Solid Color Single-Breasted Suit Jacket And Tapered Pants Set', 12),
    ('https://img.ltwebstatic.com/images3_pi/2024/04/17/ca/17133457632e4160099586560e5df1ef1ca4db7f91_thumbnail_900x.webp', 'Casual Single Breasted',44.99 , 50, 'Yody', 'Made In China', 'Purple', 'Cotton', 'Manfinity Mode Men Solid Color Casual Single Breasted Suit Jacket And Suit Pants Set', 12),
	...
	INSERT INTO products (thumbnail_image, [name], price, quantity, brand, made_in, color, material, description, category_id) VALUES
    ('https://img.ltwebstatic.com/images3_pi/2023/11/06/09/1699238984944bb523451def62bb9d88817149eb73_thumbnail_900x.webp', 'Pullover Sweater',22.49 , 50, 'Gumac', 'Made In VietNam', 'White Green', 'Cotton', 'ROMWE Street Life Mens Color-block Pullover Sweater', 13),
    ('https://img.ltwebstatic.com/images3_pi/2022/12/12/1670815624407ec21de7332021018eabf8dde8549c_thumbnail_900x.webp', 'Graffiti Print Jumper',22.49 , 50, 'Canifa', 'Made In VietNam', 'Multicolor', 'Cotton', 'Manfinity Homme Men Manfinity EMRG Men Graffiti Print Jumper', 13),
    ('https://img.ltwebstatic.com/images3_pi/2023/11/13/22/16998399812a1e4707c7e83f5649bcb76f7bfd8465_thumbnail_900x.webp', 'Round Neck Sweater',6.49 , 50, 'Yody', 'Made In China', 'Multicolor', 'Cotton', 'Manfinity Homme Mens Color Block Round Neck Sweater', 13),
    ('https://img.ltwebstatic.com/images3_pi/2024/04/28/4e/1714270533771148daa90acbd16389803dfebf9a06_thumbnail_900x.webp', 'Graphic Pattern Sweater',20.49 , 50, 'OWen', 'Made In Indonesia', 'Multicolor', 'Cotton', 'ROMWE Street Life Men Graphic Pattern Sweater & 1pc Drawstring Waist Shorts', 13),
    ('https://img.ltwebstatic.com/images3_pi/2023/08/29/bb/1693274493d0f395650583b4525bc3a9699391d142_thumbnail_900x.webp', 'Shoulder Sweater Without',22.99 , 50, 'Gumac', 'Made In VietNam', 'Light Grey', 'Cotton', 'DAZY Men Two Tone Drop Shoulder Sweater Without Tee', 13),
    ('https://img.ltwebstatic.com/images3_pi/2024/01/26/a5/1706252939105c7a606b96ae7f1e853c28fedee3f5_thumbnail_900x.webp', 'Polo Collar Sweater',21.99 , 50, 'Tingoan', 'Made In VietNam', 'Multicolor', 'Cotton', 'DAZY Mens Striped Polo Collar Sweater Polo Shirt', 13),
    ('https://img.ltwebstatic.com/images3_pi/2023/08/29/42/1693274288c9423bfcbcfaa8b5ad57e331fa58a426_thumbnail_900x.webp', 'Button Up Cardigan',25.99 , 50, 'Gumac', 'Made In VietNam', 'Grey', 'Cotton', 'DAZY Men Ribbed Knit Drop Shoulder Button Up Cardigan', 13),
    ...
    ('https://img.ltwebstatic.com/images3_pi/2024/01/18/11/170554759311c5712947a666fb95a90d3abe7fbe9d_thumbnail_900x.webp', 'Hooded Jacket',20.39 , 50, 'Gumac', 'Made In VietNam', 'Black', 'Cotton', 'Manfinity RSRT Men Letter Graphic Drawstring Hem Hooded Jacket', 14),
    ('https://img.ltwebstatic.com/images3_pi/2023/11/01/bf/169883790163c2d14539594f5e4b6498c1a3068b6d_thumbnail_900x.webp', 'Printed Athletic Jacket',25.49 , 50, 'Tingoan', 'Made In VietNam', 'Khaki', 'Cotton', 'Manfinity Homme Men Extended Sizes Men Plus Letter Printed Athletic Jacket', 14),
    ('https://img.ltwebstatic.com/images3_pi/2024/05/16/2c/171578935557f9f81edd5f07e8981f91a5b5450f16_thumbnail_900x.webp', 'Simple Hooded Jacket',28.49 , 50, 'Gumac', 'Made In VietNam', 'Black', 'Cotton', 'Manfinity Homme Men Solid Color Simple Hooded Jacket & Coat For Daily Wear', 14),
    ('https://img.ltwebstatic.com/images3_pi/2023/05/23/1684806668a4d826d7c1fcee2957044e0990f58645_thumbnail_900x.webp', 'Flap Pocket Vest',11.49 , 50, 'Gucci', 'Made In USA', 'Apricot', 'Cotton', 'Manfinity Hypemode Men Flap Pocket Vest Without Tee', 14);

	INSERT INTO products (thumbnail_image, [name], price, quantity, brand, made_in, color, material, description, category_id) VALUES
    ('https://img.ltwebstatic.com/images3_pi/2023/05/08/1683527853ff3c79511ef8c5cdc40f47efc3ab36d4_thumbnail_900x.webp', 'Waist Swim Trunks',10.49 , 50, 'Gumac', 'Made In VietNam', 'Multicolor', 'Cotton', 'Manfinity Swimmode Men Tropical Print Drawstring Waist Swim Trunks Sleeve Casual T-Shirt', 15),
    ('https://img.ltwebstatic.com/images3_pi/2022/07/28/165899615135bff9e719162fd06127bb1482816791_thumbnail_900x.webp', 'Contrast Trim',9.19 , 50, 'Canifa', 'Made In VietNam', 'Navy Blue', 'Cotton', 'Manfinity Swimmode Men Contrast Trim Drawstring Waist Swim Trunks', 15),
    ('https://img.ltwebstatic.com/images3_pi/2024/02/05/72/17071074224a7f9fc867e278a0cb3a7b7abb312785_thumbnail_900x.webp', 'Waist Beach Shorts',12.99 , 50, 'Yody', 'Made In China', 'Multicolor', 'Cotton', 'Manfinity Homme Loose Plus Size Gradient Color Drawstring Waist Beach Shorts', 15),
    ('https://img.ltwebstatic.com/images3_pi/2024/05/20/ec/171617242530d5ce2514d8a5c914981768fbf35703_thumbnail_900x.webp', 'Vacation Leopard Print',11.99 , 50, 'OWen', 'Made In Indonesia', 'Multicolor', 'Cotton', 'Manfinity Mens Vacation Leopard Print Drawstring Elastic Waist Loose Fit Beach Shorts', 15),
    ('https://img.ltwebstatic.com/images3_pi/2024/05/27/9c/1716810190b445b078c9feaacc397b69a90bc06529_thumbnail_900x.webp', 'Casual Beach Shorts',10.49 , 50, 'Gumac', 'Made In VietNam', 'Black and White', 'Cotton', 'Mens Plus Size Cow Print Drawstring Waist Holiday Casual Beach Shorts', 15),
    ('https://img.ltwebstatic.com/images3_pi/2024/05/17/1f/17159305548c55c739e844e280a47a3dbe785e3530_thumbnail_900x.webp', 'Eagle Printed Drawstring',7.49 , 50, 'Tingoan', 'Made In VietNam', 'Dark Grey', 'Cotton', 'Manfinity Homme Men Summer Holiday 3D Eagle Printed Drawstring Waist Beach Shorts', 15),
    ('https://img.ltwebstatic.com/images3_pi/2024/05/19/54/1716048104e98edc215317a2c58419a0051a4ffa0d_thumbnail_900x.webp', ' Summer Vacation',7.99 , 50, 'Gumac', 'Made In VietNam', 'Dark Orange', 'Cotton', 'Manfinity Homme Men Summer Vacation 3D Palm Tree Printed Drawstring Waist Beach Shorts', 15),
    ('https://img.ltwebstatic.com/images3_pi/2023/05/30/1685440660a7222733708806a08b15ca9ace241e39_thumbnail_900x.webp', 'Compression Liner',11.04 , 50, 'Gucci', 'Made In USA', 'Blue and White', 'Cotton', 'Manfinity Swimmode Men Striped Drawstring Waist Swim Trunks & Compression Liner', 15);

	INSERT INTO products (thumbnail_image, [name], price, quantity, brand, made_in, color, material, description, category_id) VALUES
    ('https://img.ltwebstatic.com/images3_pi/2024/04/24/89/17139362099cb08deb626aea7d6d7c526d8b311ee7_thumbnail_900x.webp', 'Straight Overalls Trousers',7.65 , 50, 'Gumac', 'Made In VietNam', 'Navy Green', 'Cotton', 'Manfinity Homme Men Fashionable Loose Straight Overalls Trousers, Casual', 16),
    ('https://img.ltwebstatic.com/images3_pi/2023/11/02/53/1698911463c1e8c386998159dfc391a3cf91a29eb2_thumbnail_900x.webp', 'Dungarees Jumpsuit',14.49 , 50, 'Canifa', 'Made In VietNam', 'Khaki', 'Cotton', 'Manfinity Homme Men Loose Fit Plus Size Solid Color Straight Leg Dungarees Jumpsuit', 16),
    ('https://img.ltwebstatic.com/images3_pi/2024/04/02/e1/1712059178ebf847db18ba7ea1765b4b7c2b87bd97_thumbnail_900x.webp', 'Drawstring Waist Romper',8.99 , 50, 'Yody', 'Made In China', 'Grey', 'Cotton', 'Manfinity Homme Loose Plus Size Stand Collar Drawstring Waist Romper', 16),
    ('https://img.ltwebstatic.com/images3_pi/2024/05/14/da/1715656065e48cafbf4565e7371699b8352d06cb41_thumbnail_900x.webp', 'Short-Sleeved Jumpsuit',25.49 , 50, 'OWen', 'Made In Indonesia', 'Navy Khaki', 'Cotton', 'Manfinity Homme Men Spring/Summer Casual Solid Color Short-Sleeved Jumpsuit', 16),
    ('https://img.ltwebstatic.com/images3_pi/2023/11/22/ba/17006418091a733434280f9ede607945cf79606bf1_thumbnail_900x.webp', 'Lined Denim Overalls',14.70 , 50, 'Gumac', 'Made In VietNam', 'Blue', 'Cotton', 'Manfinity Hypemode Plus Size Mens Flap Pocket Workwear Thermal Lined Denim Overalls', 16),
    ('https://img.ltwebstatic.com/images3_pi/2024/04/19/47/17135188235291dad03a5c8965fd494873198f4325_thumbnail_900x.webp', 'Jumpsuit With Pockets',19.49 , 50, 'Tingoan', 'Made In VietNam', 'Black', 'Cotton', 'Manfinity CasualCool Men Casual Solid Color Drawstring Waist Jumpsuit With Pockets, Spring/Summer Cargo Men Shorts', 16),
    ('https://img.ltwebstatic.com/images3_pi/2024/02/04/17/1707034322a014be39a12933822db24f1b45e79de4_thumbnail_900x.webp', 'Overalls With Braces',11.99 , 50, 'Gumac', 'Made In VietNam', 'Navy Grey', 'Cotton', 'Manfinity Homme Men Plus Size Casual Overalls With Braces', 16),
    ('https://img.ltwebstatic.com/images3_pi/2024/02/27/42/17090117908bf576f384dc6ce78648a50c1f1a939e_thumbnail_900x.webp', 'Casual Shirt Romper',13.57 , 50, 'Gucci', 'Made In USA', 'Moss Brown', 'Cotton', 'Manfinity Homme Men Short Sleeve Woven Casual Shirt Romper', 16);
	
	INSERT INTO products (thumbnail_image, [name], price, quantity, brand, made_in, color, material, description, category_id) VALUES
    ('https://img.ltwebstatic.com/images3_spmp/2023/11/14/f7/1699969454a78fd6c4384747e4d700a685bcb7e1b4_thumbnail_900x.webp', '5pairs/pack Kids Socks',2.97 , 50, 'Gumac', 'Made In VietNam', 'Mixture', 'Cotton', '5pairs/pack Kids Socks, College Style Two-bar Striped Sport Socks, Unisex Baby Socks, White Mid-calf Socks For Students', 17),
    ('https://img.ltwebstatic.com/images3_spmp/2023/12/23/c8/1703291404713a19b36eac546b50d2ee12ab2c2315_thumbnail_900x.webp', '5 Pairs Unisex Kids',2.00 , 50, 'Canifa', 'Made In VietNam', 'Mixture', 'Cotton', '5 Pairs Unisex Kids Mesh Thin Korean Style Athletic Socks, Spring/Summer', 17),
    ('https://img.ltwebstatic.com/images3_spmp/2023/12/24/bb/170338967360f9fbb313193d6058dc593bd44b6ff6_thumbnail_900x.webp', '5pairs Kids Cartoon',2.25 , 50, 'Yody', 'Made In China', 'Mixture', 'Cotton', '5pairs Kids Cartoon Floral And Candy Pattern Mid-Calf Socks For Girls, Breathable And Comfortable, Suitable For Four Seasons', 17),
    ('https://img.ltwebstatic.com/images3_spmp/2023/08/19/3c/169241515488941dba1cb6a3bda317cefac972d8a8_thumbnail_900x.webp', '1pc Girls Red Basic Leggings',1.57 , 50, 'OWen', 'Made In Indonesia', 'Red', 'Cotton', '1pc Girls Red Basic Leggings With Bowknot Decoration, All Seasons Shorts', 17),
    ('https://img.ltwebstatic.com/images3_spmp/2023/10/29/45/169856985892b4be89f91565307c8cf55139ca3b66_thumbnail_900x.webp', '5pairs Kids Trendy',2.50 , 50, 'Gumac', 'Made In VietNam', 'Mixture', 'Cotton', '5pairs Kids Trendy Spring/autumn Casual Medium-tube Socks, Breathable And Durable For Daily Wear', 17),
    ('https://img.ltwebstatic.com/images3_spmp/2024/04/12/c0/17128928811ce2dfbaebe1d7b47d171ae6bb6799c8_thumbnail_900x.webp', '5pairs Girls Cute Strawberry',2.50 , 50, 'Tingoan', 'Made In VietNam', 'Pink', 'Cotton', '5pairs Girls Cute Strawberry Bubble Mouth & Lace Trim Short Socks, Suitable For Spring And Summer', 17),
    ('https://img.ltwebstatic.com/images3_spmp/2023/12/12/af/17023650087d93986800d5166905fd0eb705e4ea6b_thumbnail_900x.webp', '5 Pairs Of Cute Dinosaur',2.06 , 50, 'Gumac', 'Made In VietNam', 'Mixture', 'Cotton', '5 Pairs Of Cute Dinosaur Crocodile Fashionable And Versatile Daily Mid-Calf Socks For Men And Women', 17),
    ('https://img.ltwebstatic.com/images3_spmp/2024/03/27/6b/171151981435e611b296be35b7f6d81840b0d91778_thumbnail_900x.webp', '3 Pairs Of White Princess',3.57 , 50, 'Gucci', 'Made In USA', 'White', 'Cotton', '3 Pairs Of White Princess Style Lace Mesh Breathable Lace Socks For Girls, Suitable For Daily Wear', 17);

	INSERT INTO products (thumbnail_image, [name], price, quantity, brand, made_in, color, material, description, category_id) VALUES
    ('https://img.ltwebstatic.com/images3_pi/2024/03/27/ca/17115098622516b62fb5e2351ba559cad2342f9a99_thumbnail_900x.webp', 'Newborn Baby Girl',5.99 , 50, 'Gumac', 'Made In VietNam', 'Mixture', 'Cotton', 'SHEIN Newborn Baby Girl Leopard Print Sleeveless Jumpsuit, Casual And Lovely, Matching Mother And Me Outfits', 18),
    ('https://img.ltwebstatic.com/images3_pi/2024/05/27/10/17167907479309fd0236980e057275314f6992e900_thumbnail_900x.webp', 'Corduroy Solid Color',6.49 , 50, 'Canifa', 'Made In VietNam', 'White & Brown', 'Cotton', 'SHEIN Newborn Baby Girl Casual Corduroy Solid Color Overalls Shorts, Elastic Waist Strap', 18),
    ('https://img.ltwebstatic.com/images3_pi/2024/01/12/71/17050405508df5dc1b6e089d74e67e2293fbdff527_thumbnail_900x.webp', 'Short Sleeve T-Shirt',1.99 , 50, 'Yody', 'Made In China', 'Yellow', 'Cotton', 'SHEIN Young Girls Cartoon Printed Short Sleeve T-Shirt', 18),
    ('https://img.ltwebstatic.com/images3_pi/2024/04/02/3a/171202762551200971b743c2163215cdfd96a124d4_thumbnail_900x.webp', 'Romper With Cross Neck',5.99 , 50, 'OWen', 'Made In Indonesia', 'Green', 'Cotton', 'Baby Girl Solid Color Romper With Cross Neck & Textured Fabric Design, Perfect For Summer Vacation', 18),
    ('https://img.ltwebstatic.com/images3_pi/2024/04/06/98/171239035873454dd431a662283aa9d2a2c8be760a_thumbnail_900x.webp', 'Letter Slogan Print',2.99 , 50, 'Gumac', 'Made In VietNam', 'White', 'Cotton', 'Young Boy Casual Short Sleeve Round Neck T-Shirt With Letter Slogan Print', 18),
    ('https://img.ltwebstatic.com/images3_pi/2024/03/29/c1/1711688331bb27a23983e5658c26ea438710ddc567_thumbnail_900x.webp', 'Teen Girl Sweet',17.49 , 50, 'Tingoan', 'Made In VietNam', 'Pink', 'Cotton', 'Teen Girl Sweet And Comfortable Blouse Collar Mesh Ruffle Sleeve Top And Nine Points Long Pants Home Wedding Flower Girl Party Two-Piece Set Sibling Outfits Mathing Outfits (2 Sets Are Sold Separately)', 18),
    ('https://img.ltwebstatic.com/images3_pi/2023/12/21/98/1703152125905bda9010851dbeebbddc2d81a43907_thumbnail_900x.webp', 'Tween Girl Knitted',4.99 , 50, 'Gumac', 'Made In VietNam', 'Pink', 'Cotton', 'Tween Girl Knitted Solid Color Vest Romper With Decorative Buttons, Removable Belt And Suit Collar, Matching Mommy And Me Outfits (2 Pieces Sold Separately)', 18),
    ('https://img.ltwebstatic.com/images3_pi/2023/12/12/01/17023591381f3514e555dc264677e6ee17ff8d7900_thumbnail_900x.webp', 'Sweatpants Two-Piece',13.57 , 50, 'Gucci', 'Made In USA', 'Brown', 'Cotton', 'Baby Boy Hooded Sweatshirt And Sweatpants Two-Piece Set Dad And Me (2 Sets Sold Separately)', 18);

	INSERT INTO products (thumbnail_image, [name], price, quantity, brand, made_in, color, material, description, category_id) VALUES
    ('https://img.ltwebstatic.com/images3_pi/2023/06/30/1688109089626eac631cd1fb779a8a1d158b05eec3_thumbnail_900x.webp', 'Pattern Pink Jacket',5.49 , 50, 'Gumac', 'Made In VietNam', 'Pink', 'Cotton', 'Young Girl Rainbow Unicorn Fun Pattern Pink Jacket', 19),
    ('https://img.ltwebstatic.com/images3_pi/2022/10/19/1666165316bdcace2c5e4c9fcc89ba5a65d4796d4c_thumbnail_900x.webp', 'Young Girl Cherry',8.49 , 50, 'Canifa', 'Made In VietNam', 'White', 'Cotton', 'Young Girl Cherry Embroidery Drop Shoulder Duster Cardigan', 19),
    ('https://img.ltwebstatic.com/images3_spmp/2024/02/01/8f/17067545811368a5d8ac5f4ab1a6ca8099d8c1f684_thumbnail_900x.webp', 'Including Breathable Ruffle',4.99 , 50, 'Yody', 'Made In China', 'Pink', 'Cotton', '2pcs Young Girls Casual And Adorable Outfit, Including Breathable Ruffle Top And Flower Printed Cinching Waist Sundress For Spring And Summer', 19),
    ('https://img.ltwebstatic.com/images3_pi/2023/12/16/47/1702707992178fddb88e13173f61dcdf641193cffb_thumbnail_900x.webp', 'Heart Pattern Short ',1.99 , 50, 'OWen', 'Made In Indonesia', 'Pink', 'Cotton', 'Young Girls Casual Heart Pattern Short Sleeve T-Shirt, Suitable For Summer', 19),
    ('https://img.ltwebstatic.com/images3_pi/2023/03/23/167954329526928ead23b554824b3c58fb98552faa_thumbnail_900x.webp', 'Toddler Girls Tropical',4.49 , 50, 'Gumac', 'Made In VietNam', 'Multicolor', 'Cotton', 'Young Girl Toddler Girls Tropical Print Belted Romper', 19),
    ('https://img.ltwebstatic.com/images3_pi/2022/12/29/16722851688012d568acf698fa6e09d2723fa545c5_thumbnail_900x.webp', 'Girl Cartoon Graphic',4.63 , 50, 'Tingoan', 'Made In VietNam', 'White', 'Cotton', 'Young Girl Cartoon Graphic Ruffle Trim Tee & Belted Shorts', 19),
    ('https://img.ltwebstatic.com/images3_pi/2023/11/15/32/1700017692f97a43018635512803fdd95681e68d35_thumbnail_900x.webp', 'Hand Gesture Print',2.99 , 50, 'Gumac', 'Made In VietNam', 'Coral Pink', 'Cotton', 'Young Girl Short Sleeve T-Shirt With Lettering And Hand Gesture Print, Perfect For Summer', 19),
    ('https://img.ltwebstatic.com/images3_spmp/2023/09/01/53/1693561117ad5a05ec8aaf8d5a80c728393e01e5a3_thumbnail_900x.webp', 'Lovely Ruffled Lace',6.99 , 50, 'Gucci', 'Made In USA', 'Red and White', 'Cotton', 'Girls Lovely Ruffled Lace Decorated Tank Top & Shorts Set', 19);

	INSERT INTO products (thumbnail_image, [name], price, quantity, brand, made_in, color, material, description, category_id) VALUES
    ('https://img.ltwebstatic.com/images3_pi/2024/03/29/d8/1711697018cd5d4b3549e8b8c3d35b0620eabb09bd_thumbnail_900x.webp', 'Elegant Spaghetti',5.95 , 50, 'Gumac', 'Made In VietNam', 'Navy Blue', 'Cotton', 'SHEIN Teen Girl Elegant Spaghetti Strap Dress With Floral Print And Mesh Overlay For Summer', 21),
    ('https://img.ltwebstatic.com/images3_pi/2024/04/25/d1/1714031625cb6b8dd7cbdfe10f5582449f48999765_thumbnail_900x.webp', 'Ditsy Floral Print Ruffle',12.99 , 50, 'Canifa', 'Made In VietNam', 'Multicolor', 'Cotton', 'Teen Girls Ditsy Floral Print Ruffle Trim Ruched Bust Two Layer Hem Dress', 21),
    ('https://img.ltwebstatic.com/images3_pi/2023/11/27/77/1701051971be298c0343bafa4a9eb8ac8d46e865ed_thumbnail_900x.webp', 'Hooded Casual Sweatshirt',8.99 , 50, 'Yody', 'Made In China', 'Black', 'Cotton', 'Manfinity Homme Teen Girls Hooded Casual Sweatshirt With Text Print', 21),
    ('https://img.ltwebstatic.com/images3_pi/2024/05/22/97/17163456996301662783cb1504d04828300be74525_thumbnail_900x.webp', 'Woven Blue Ditsy',18.20 , 50, 'OWen', 'Made In Indonesia', 'Blue', 'Cotton', 'Teen Girls Woven Blue Ditsy Floral Print Spaghetti Strap Dress With Bowknot And Tiered Ruffle Hem', 21),
    ('https://img.ltwebstatic.com/images3_pi/2024/02/01/f1/17067824625c797afbb5314cfe1c1e7912082328a0_thumbnail_900x.webp', 'Leopard Heart',8.60 , 50, 'Gumac', 'Made In VietNam', 'White', 'Cotton', 'Teen Girl Leopard Heart Print Tee', 21),
    ('https://img.ltwebstatic.com/images3_pi/2023/12/23/23/170329742834e554e09864cbe1398f2167cc62f019_thumbnail_900x.webp', 'Sports Skirt',6.42 , 50, 'Tingoan', 'Made In VietNam', 'Pink', 'Cotton', 'Teenage Girls Knit Solid Color Sports Skirt With Built-In Shorts And Pockets', 21),
    ('https://img.ltwebstatic.com/images3_pi/2021/05/13/1620876219536fbcbab3bc447a7ac502f67d0f22ba_thumbnail_900x.webp', 'Waist Halter Romper',8.06 , 50, 'Gumac', 'Made In VietNam', 'Multicolor', 'Cotton', 'Teen Girls Floral Print Knot Waist Halter Romper Drawstring Waist Cargo Shorts', 21),
    ('https://img.ltwebstatic.com/images3_spmp/2024/05/16/80/171585005153706aaad6538f4e13800b248e580894_thumbnail_900x.webp', 'Flared Long Pants',10.57 , 50, 'Gucci', 'Made In USA', 'Pink', 'Cotton', 'Teen Girl Summer Fashion Solid Color Open Shoulder Tank Top & Flared Long Pants Two Piece Set', 21);

	
	INSERT INTO products (thumbnail_image, [name], price, quantity, brand, made_in, color, material, description, category_id) VALUES
    ('https://img.ltwebstatic.com/images3_pi/2024/04/07/ec/17124569896c3953c939e00940ae1d8f1c07e43b9d_thumbnail_900x.webp', 'Vest Gentleman Suit',12.49 , 50, 'Gumac', 'Made In VietNam', 'White Blue', 'Cotton', 'Teen Boy 2-Piece Elegant Business Style Blue Vest Gentleman Suit Set Including 1 Vest And 1 Pant', 24),
    ('https://img.ltwebstatic.com/images3_pi/2024/01/04/39/17043554341e486098d52d363994f8ac93446a0651_thumbnail_900x.webp', 'Sleeved T-Shirt',3.9 , 50, 'Canifa', 'Made In VietNam', 'Black', 'Cotton', 'Teen Boys Print Short-Sleeved T-Shirt Graffiti Print Jumper', 24),
    ('https://img.ltwebstatic.com/images3_pi/2024/01/02/af/17041768538da68141904725972f0d8545396f3e05_thumbnail_900x.webp', 'Smiling Face Printed',6.0 , 50, 'Yody', 'Made In China', 'Grey', 'Cotton', 'Teen Boys Smiling Face Printed T-shirt And Shorts Set Round Neck Sweater', 24),
    ('https://img.ltwebstatic.com/images3_pi/2024/05/29/25/17169811899069d738d6ff06b0df28d0f80f2ece1f_thumbnail_900x.webp', 'Collar Jacket',5.49 , 50, 'OWen', 'Made In Indonesia', 'Blue', 'Cotton', 'Teenage Boys Solid Color Casual Collar Jacket With Single-Breasted Button', 24),
    ('https://img.ltwebstatic.com/images3_pi/2024/02/04/ca/170702177798e25b1b0d88b55ec3ef07813e6dcb81_thumbnail_900x.webp', 'Shark Print Beach Shorts',2.69 , 50, 'Gumac', 'Made In VietNam', 'Black', 'Cotton', 'Teen Boy Vacation Style Shark Print Beach Shorts & Daddy And Me Matching Outfits (2 Pieces Sold Separately)', 24),
